...
print("X leads off")
tty_print(game1)
probs1 = calc_probs.get_probs(game1, "ex_ante")
...
tty_print(game2)
probs2 = calc_probs.get_probs(game2, "ex_ante")
...
tty_print(game3)
probs3 = calc_probs.get_probs(game3, "ex_ante")
print("X probs: p_win = {}, p_loss = {}, p_draw = {}".format(
...
print("O blocks at 6")
tty_print(game4)
probs4 = calc_probs.get_probs(game4, "ex_ante")
print("O probs: p_win = {}, p_loss = {}, p_draw = {}".format(
...
print("X blocks at 4")
tty_print(game5)
probs5 = calc_probs.get_probs(game5, "ex_ante")
print("X probs: p_win = {}, p_loss = {}, p_draw = {}".format(
...
print("O blocks at 8")
tty_print(game6)
probs6 = calc_probs.get_probs(game6, "ex_ante")
print("O probs: p_win = {}, p_loss = {}, p_draw = {}".format(
...
tty_print(game7)
probs7 = calc_probs.get_probs(game7, "ex_ante")
print("X probs: p_win = {}, p_loss = {}, p_draw = {}".format(
...
tty_print(game8)
probs8 = calc_probs.get_probs(game8, "ex_ante")
print("O probs: p_win = {}, p_loss = {}, p_draw = {}".format(
    probs8[0], probs8[1], probs8[2]))
print("\n")


# delete the instantiated class
del calc_probs
